...
class TestClippyConfig:
    ...
    def test_flat_dict_has_all_expected_keys(self, default_config):
        flat = default_config.to_flat_dict()
        expected_keys = {
            "bitrate", "audio_bitrate", "fps", "resolution",
            "container_ext", "container_flags", "yt_format",
            "nvenc_preset", "cq", "gop", "rc_lookahead",
            "aq_strength", "spatial_aq", "temporal_aq",
            "amountOfClips", "amountOfCompilations", "reactionThreshold",
            "transition_probability", "no_random_transitions",
            "transitions_weights", "transition_cooldown",
            "silence_static", "audio_normalize_transitions",
            "cache", "output",
            "max_concurrency", "skip_bad_clip", "rebuild",
            "enable_overlay", "transitions_rebuild",
            "fontfile", "static", "intro", "outro", "transitions",
            "discord_channel_id", "discord_message_limit",
            "default_broadcaster",
        }
